...
## Description
This Jupyter Notebook presents calculation of the difference between LSA SAF METREF and LSA SAF DMETv3 product. This difference can be used as an indicator of water deficit.
